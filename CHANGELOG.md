...
## [0.1.18] - 2025-12-22
### Added
- Added global keyboard shortcuts: Space to Play/Pause, Left/Right Arrows to seek 5s.
### Performance
- Optimized video player playback tracking to reduce application re-renders during playback.
