...
- **Dynamic Camera Grid:** In grid view, select any camera to replace the main view. The grid automatically rearranges, and your selection persists across clip loads (if available).
