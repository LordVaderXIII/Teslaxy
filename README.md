...
- **Export Clips:** Snip a section of a clip using red and green brackets and export to mp4.

## Upcoming Features

- Export functionality stage 2, pick which camera view is included and they are stiched together in the export
